...
- (instancetype)initAtPoint:(CGPoint)point inWindow:(UIWindow *)window onView:(UIView *)view {
    self = [super init];
    ...
    if ([self respondsToSelector:@selector(setGestureView:)]) [self setGestureView:hitTestView];
