...
@interface DaiLiJieSuoMaViewController ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,UISearchBarDelegate>
{
...
@implementation DaiLiJieSuoMaViewController
...
[_activityIndicator startAnimating];
    ...
    NSString *txturl2 = [NSString stringWithContentsOfURL:[NSURL URLWithString:[self getUTF8EncodeStringWithURLString:[NSString stringWithFormat:@"%@daili.php?id=3&daiid=%@&pass=%@",[[NSUserDefaults standardUserDefaults] objectForKey:@"代理地址"],[[NSUserDefaults standardUserDefaults] objectForKey:@"代理账号"],[[NSUserDefaults standardUserDefaults] objectForKey:@"代理密码"]]]] encoding:NSUTF8StringEncoding error:nil];
...
- (void)cellBtnClicked:(id)sender event:(id)event {
    ...
    UIAlertAction *aAction = [UIAlertAction actionWithTitle:@"复制" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        UIPasteboard *pboard = [UIPasteboard generalPasteboard];
        pboard.string = self->MYka[@"gongneng"][indexPath.section][@"卡号"];
    }];
    ...
    UIAlertAction *bAction = [UIAlertAction actionWithTitle:@"删除" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        [_activityIndicator startAnimating];
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
        NSString *txturl = [NSString stringWithContentsOfURL:[NSURL URLWithString:[self getUTF8EncodeStringWithURLString:[NSString stringWithFormat:@"%@daili.php?id=4&kami=%@&daiid=%@&pass=%@",[[NSUserDefaults standardUserDefaults] objectForKey:@"代理地址"],self->MYka[@"gongneng"][indexPath.section][@"卡号"],[[NSUserDefaults standardUserDefaults] objectForKey:@"代理账号"],[[NSUserDefaults standardUserDefaults] objectForKey:@"代理密码"]]]] encoding:NSUTF8StringEncoding error:nil];
            if(txturl){
            dispatch_async(dispatch_get_main_queue(), ^{
                [_activityIndicator removeFromSuperview];
    ...
    UIAlertAction *cAction = [UIAlertAction actionWithTitle:@"拉黑" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        [_activityIndicator startAnimating];
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            NSString *txturl = [NSString stringWithContentsOfURL:[NSURL URLWithString:[self getUTF8EncodeStringWithURLString:[NSString stringWithFormat:@"%@daili.php?id=5&udid=%@&daiid=%@&pass=%@",[[NSUserDefaults standardUserDefaults] objectForKey:@"代理地址"],self->MYka[@"gongneng"][indexPath.section][@"udid"],[[NSUserDefaults standardUserDefaults] objectForKey:@"代理账号"],[[NSUserDefaults standardUserDefaults] objectForKey:@"代理密码"]]]] encoding:NSUTF8StringEncoding error:nil];
    ...
    UIAlertAction *dAction = [UIAlertAction actionWithTitle:@"拉黑udid并删除" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        [_activityIndicator startAnimating];
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            NSString *txturl = [NSString stringWithContentsOfURL:[NSURL URLWithString:[self getUTF8EncodeStringWithURLString:[NSString stringWithFormat:@"%@daili.php?id=6&udid=%@&daiid=%@&pass=%@&kami=%@",[[NSUserDefaults standardUserDefaults] objectForKey:@"代理地址"],self->MYka[@"gongneng"][indexPath.section][@"udid"],[[NSUserDefaults standardUserDefaults] objectForKey:@"代理账号"],[[NSUserDefaults standardUserDefaults] objectForKey:@"代理密码"],self->MYka[@"gongneng"][indexPath.section][@"卡号"]]]] encoding:NSUTF8StringEncoding error:nil];
            if(txturl){
            dispatch_async(dispatch_get_main_queue(), ^{
                [_activityIndicator removeFromSuperview];
           NSMutableDictionary *dd = [NSJSONSerialization JSONObjectWithData:[txturl dataUsingEncoding:NSUTF8StringEncoding] options:NSJSONReadingMutableContainers error:nil];
